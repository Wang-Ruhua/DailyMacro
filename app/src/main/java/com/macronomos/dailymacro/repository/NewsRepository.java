...
import com.macronomos.dailymacro.DailyMacroApplication;
...
public class NewsRepository {
    ...
    private final DailyMacroDatabase database;

    public NewsRepository() {
        newsApi = RetrofitClient.newInstance().create(NewsApi.class);
        database = DailyMacroApplication.getDatabase();
    }
    ...
    private static class FavoriteAsyncTask extends AsyncTask<Article, Void, Boolean> {
        ...
        private FavoriteAsyncTask(DailyMacroDatabase database, MutableLiveData<Boolean> liveData) {
